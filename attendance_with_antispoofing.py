...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        bg_photo = PhotoImage(file = "Photos/background7.png", master = first)
                        background_pic = Label(first, image = bg_photo)
                        background_pic.pack()
                        first.title("Manage Employee post")
                        face = Label(first, text = "Employee Details Management" , bg = "black" , fg = "white", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 1, relief =FLAT).place(x = 500, y = 10)
                        main = Label(first, bg = "white", borderwidth = 1).pack()
                        def back():
                            first.destroy() 
                    ...
                    ################################################## Employee Management form ###############################
                        ...
                        btn1 = Button(f3, text = "Add", bg = "black", fg="white",height = "1", width = "7",command = add_employee, font = ("Times new Roman", 14 , "bold")).place(x = 10, y = 10)
                        btn2 = Button(f3, text = "Update", bg = "black", fg="white",height = "1", width = "7", command = update, font = ("Times new Roman", 14 , "bold")).place(x = 105, y = 10)
                        btn3 = Button(f3, text = "Delete", bg = "black", fg="white", height = "1", width = "7", command = delete,  font = ("Times new Roman", 14 , "bold")).place(x = 205, y = 10)
                        btn4 = Button(f3, text = "Clear", bg = "black", fg="white",height = "1", width = "7", command = clear, font = ("Times new Roman", 14 , "bold")).place(x = 305, y = 10)
                ...
                def train(): 
                    try:
                        ...
                        img3= PhotoImage(file = "Photos/background7.png", master = second)
                        backgrd = Label(second, image = img3)
                        backgrd.pack()
                        train_title = Label(second, text = "Data Training", fg = 'white', font = ("times new roman", 20, "bold"), bg = "black")
                        ...
                        def progress():
                            ...
                            try:
                                ...
                                f1.close()
                                messagebox.showinfo("Success", "Training Done Successfully..", parent = attendance)
                        ...
                        progress_bar.place(x = 350, y = 310) 
                        btn = Button(second, text = "Start Training", fg = 'white',font = ("Times new roman", 20, "bold"), command = progress, bg = "black" )
                        btn.place(x = 503, y = 245) 
                        second.mainloop()
                    except Exception as e:
                        second.after(1000,second.destroy)
                        messagebox.showerror("Error","{} not found.".format(e))
    ...
    ######################################### Function to recognize the face
                ...
                def change():
                    ...
                    admin_logo = Label(account_frame,  bg = 'white').place( y = 70, relwidth = 1)
                ...
                def report():
                    ...
                    report.config(bg = "black")
                    title = Frame(report, bg = "black", bd = "3", relief = SUNKEN )
                    title.pack(fill = BOTH)
                    title_label = Label(title, text = "Attendance Report", font = ("times new roman", 30, "bold"), fg = "white", bg = "black")
                    title_label.pack()
                    def back():
                        report.destroy()
                    backbtn = Button(title, text = 'Back' , bg = "black" , fg = "white", font = ("Times New Roman", 20 ,"bold"), relief = RIDGE, command = back).place(x = 1250, y = 0)
                    ...
                    search_text = StringVar()
                    ####################################### Textfill Frame 
                    text_fill = Frame(report, height = 620, width = 1350, bg= "black", borderwidth = "3", relief = SUNKEN)
                ...
                def face_embedding():
                    ...
                    img1= PhotoImage(file = "Photos/background7.png", master = fe)
                    backgrd = Label(fe, image = img1)
                    backgrd.pack()
                    embed_title = Label(fe, text = "Extract And Save Embeddings",fg="white",font = ("times new roman", 30, "bold"), bg = "black")
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        def start_extracting_embedding(pixels):   
                            ...
                            messagebox.showinfo("Success", "Embedding extracted successfully.. ", parent = attendance)
                        def back():
                            fe.destroy()
                        backbtn = Button(fe, text = 'Back', fg = 'White', bg = 'black', font = ('times new roman', 18 , 'bold'), command = back).place(x = 1250, y = 1)
                        l = len(face_pixels)
                        percent = StringVar()
                        text = StringVar()  
                        ...
                        textlabel.place(x=475,y=500)                                                                                                        #200
                        btn = Button(fe,text="Start Extracting Embeddings",fg = 'white', font = ("Times new roman", 20, "bold"),command=lambda: start_extracting_embedding(pixels=face_pixels),bg="black")
                ...
                bg_image = PhotoImage(file = "Photos/background7.png", master = attendance)
                ...
                manage = 'Employee Attendance Management System'
                topic = Label(attendance, text = manage , bg = "black" , fg = "white", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 1, relief = RIDGE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/rec.png", master = attendance)
                B1 = Button(text = "Employee Details Management", bg = "white" , fg = "black", font = ("Times new Roman", 15), height = 2, width = 24,command= manage_employee, compound = BOTTOM)
                B1.place(x = 120, y =100)
                # B1 = Button(text = "Employee Management",font = ("Times New Roman" , 15), bg = "black" , fg = "white", height =230, width = 265, command = manage_employee, compound = BOTTOM )
                # B1.place(x = 20, y = 100)
                photo2 = PhotoImage(file = "Photos/rec.png",  master = attendance)
                # B9 = Button(text = "Employee Management", bg = "white" , fg = "black", font = ("Times new Roman", 15), height = 2, width = 24,command= manage_employee, compound = BOTTOM)
                # B9.place(x = 20, y =400)
                B2 = Button(text = "Face Recognizer", font = ("Times new roman", 15), bg = "white" , fg = "black", height = 2, width= 24, command = face_recognize, compound = BOTTOM )
                B2.place(x = 120, y = 300)
                photo3 = PhotoImage(file = "Photos/train.png",  master = attendance)
                B3 =  Button(text = "Data training" , font = ("Times new roman", 15), bg = "white" , fg = "black", height = 2, width= 24, command = train , compound = BOTTOM )
                B3.place(x = 460, y = 100)
                photo4 = PhotoImage(file = "Photos/exit1.png",  master = attendance )
                B4 = Button(text="Exit", bg = "white" , fg = "black",font = ("Times new Roman", 15), height = 2, width = 24 , command = exit, compound = BOTTOM)
                B4.place(x =800, y = 300)
                photo5 = PhotoImage(file = "Photos/report.png" ,  master = attendance)
                B5 = Button(text = "Attendance Report", bg = "white" , fg = "black", font = ("Times new roman", 15), height = 2, width = 24, command = report, compound = BOTTOM)
                B5.place(x = 460, y = 300)
                photo6 = PhotoImage(file = "Photos/photosample.png",  master = attendance)
                # B6 = Button(text = "Photo Samples" , bg = "white" , fg = "black", font =("Times new roman",15),  height = 2, width = 24, command = photo_samples, compound = BOTTOM )
                # B6.place(x = 700, y= 100) 
                photo7 = PhotoImage(file = "Photos/passwordchange.png", master = attendance)
                # B7 = Button(text="Admin Account" , bg = "white" , fg = "black",font =("Times new roman",15), height = 2, width = 24, command = change, compound = BOTTOM )
                # B7.place(x = 700, y = 300)
                photo8 = PhotoImage(file = "Photos/embeddings.png", master = attendance)
                B8 = Button(text = "Extract Embeddings", bg = "white" , fg = "black", font = ("Times new Roman", 15), height = 2, width = 24,command= face_embedding, compound = BOTTOM)
                B8.place(x = 800, y =100)

                # B9 = Button(text = "Extract Embeddings", bg = "black" , fg = "white", font = ("Times new Roman", 15), height = 5, width = 20,command= manage_employee, compound = BOTTOM)
                # B9.place(x = 1040, y =100)
                attendance.mainloop()
        except pymysql.err.OperationalError as e:
            messagebox.showerror( "Error","Sql Connection Error... Open Xamp Control Panel and then start MySql Server ")
        except Exception as e:
...
#Admin login page
bg_icon = PhotoImage(file = "Photos/background7.png", master = face)
background_image = Label(face, image = bg_icon)
background_image.pack()



title = Label(face, text = "Login Page" , font = ("times new roman", 30, "bold"), bg = "black", fg = "white", bd = 1, relief = FLAT) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "black", fg="white", relief = FLAT)
...
logo_image = Label(login_frame,bd = 0 ).grid( row = 0, columnspan = 3 , pady = 20, padx= 40)
...
submit_btn = Button(login_frame, fg="white",text = "Log in",width = 10, activebackground = "black", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = "black").grid(row = 3, column = 1, pady =25, padx = 25) 
face.mainloop()            